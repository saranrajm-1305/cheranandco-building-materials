...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Us — Cheran & Co. Building Materials Supplier" },
      { name: "description", content: "Learn about Cheran & Co. — Coimbatore's trusted partner for cement, steel, blocks and aggregates. Quality, reliability, and 24/7 service." },
      { property: "og:title", content: "About — Cheran & Co." },
      { property: "og:description", content: "Coimbatore's trusted building materials supplier — quality, reliability and 24/7 service." },
